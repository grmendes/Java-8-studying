package com.test.gmendes.stream.study.java7.v3;
 ...
 * @version 3
 */
public class ProcessJava7V3 {

    private final String path;

    public ProcessJava7V3(String path) {
        this.path = path;
    }
    ...
    private List<String> process(Map.Entry<String, List<String>> entry) {
        ...
        final List<String[]> layoutLines = new ArrayList<>();
        for (String line : layout) {
            columns.add(line.split(SEPARATOR)[0]);
            layoutLines.add(line.split(SEPARATOR));
        }
        ...
        for (String fileLine : fileData) {
            ...
            for (String[] layoutInfo : layoutLines) {
