 ...
 *
 * This class holds basically the Java 7's second version translated into Kotlin. Was used IntelliJ Idea's tool for
 * converting Java to Kotlin, in order to create a first version.
 *
 * @author grmendes
 *
 * @version 1
